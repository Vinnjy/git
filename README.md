...
## Удалённые репозитории:
  ...
  * ### [Удалённые ветки = "git checkout origin/main"](#title17)

  * ### [Извлечение/скачивание данных из удаленного репозитория = "git fetch"](#title18)

  * ### [git fetch и git merge = "git pull"](#title19)
...
## <a id ="title17">Удалённые ветки</a>
...
## <a id ="title18">Извлечение данных из удалённого репозитория</a>
...
## <a id ="title19">git fetch и git merge = "git pull"/a>
